...
call "%~dp0..\gradlew.bat" --no-daemon --console=plain -p "%~dp0..\hosts\fabric\1.19.2" "-Dlodestone.port=%LODESTONE_PORT%" "-Dlodestone.token=%LODESTONE_TOKEN%" "-Dlodestone.permissions=%LODESTONE_PERMISSIONS%" runClient
exit /b %ERRORLEVEL%
