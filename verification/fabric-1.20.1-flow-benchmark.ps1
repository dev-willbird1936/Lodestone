...
param(
    ...
    [string] $LodestoneArtifact = (Join-Path $PSScriptRoot '..\hosts\fabric\1.20.1\build\libs\lodestone-1.0.0.jar'),
    [string] $ClientRunDirectory = (Join-Path $PSScriptRoot '..\hosts\fabric\1.20.1\run')
)
