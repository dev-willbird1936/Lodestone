...
call "%~dp0..\gradlew.bat" --no-daemon --console=plain -p "%~dp0..\hosts\forge\1.21.1" "-Dlodestone.port=%LODESTONE_PORT%" "-Dlodestone.token=%LODESTONE_TOKEN%" "-Dlodestone.permissions=%LODESTONE_PERMISSIONS%" runArtifactClient
exit /b %ERRORLEVEL%
