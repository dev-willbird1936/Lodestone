...
| ✅ | Fabric 26.2 client flow (post-v1 source) | Exact Java 25 artifact passed 100 main-menu assertions, 31 minimal-world assertions including reversible block mutation/readback, bundled `simple_chair` stateful placement/readback/restoration, client-context player-look mutation/readback/restore, revision-checked container read/click/readback/close, and 6/6 clean-shutdown assertions. Heightmap/light/move/slot/chat-read remain explicit unsupported states; furniture is now verified on this exact adapter. This evidence does not alter v1.0.0. |
...
| ✅ | Fabric 26.2 real world + container/furniture control | 31/31 asserted records; reversible gold-block mutation/readback, bundled `simple_chair` stateful placement/readback/restoration, client-context player look readback/restore, screenshot, revision/46-slot container read, guarded empty-slot click/readback/close, and explicit heightmap/light/move/slot/chat-read unsupported states |
