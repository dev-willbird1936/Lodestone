...
| ✅ | Fabric 26.2 client flow (post-v1 source) | Exact Java 25 artifact passed 100 main-menu assertions, 24 minimal-world assertions including reversible block mutation/readback, player-look readback, revision-checked container read/click/readback/close, and 6/6 clean-shutdown assertions. Heightmap/light/move/slot/chat-read and bundled furniture remain explicit unsupported states. This evidence does not alter v1.0.0. |
...
| ✅ | Fabric 26.2 real world + container control | 24/24 asserted records; reversible gold-block mutation/readback, player look readback/restore, screenshot, revision/46-slot container read, guarded empty-slot click/readback/close, and explicit heightmap/light/move/slot/chat-read/furniture unsupported states |
