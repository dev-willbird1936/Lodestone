...
| ✅ | Fabric 26.2 Java 25 minimal-world container/menu control slice | Fresh exact artifact passed 100 main-menu records and 25 minimal-world records: raw inventory key dispatch opened `InventoryScreen`, revision/46-slot container read, client-context look mutation/readback/restore, revision-guarded empty-slot click, readback with the slot unchanged, close dispatch, and clean shutdown. Furniture remains unsupported on this exact adapter. Artifact SHA-256: `b299bfcb8036b23a954abed67f7801e99646eb500ed35863a04c9c346ee9c526`. |
...
| ✅ | Fabric 26.2 client flow (post-v1 source) | Exact Java 25 artifact passed 100 main-menu assertions, 25 minimal-world assertions including reversible block mutation/readback, client-context player-look mutation/readback/restore, revision-checked container read/click/readback/close, and 6/6 clean-shutdown assertions. Heightmap/light/move/slot/chat-read and bundled furniture remain explicit unsupported states. This evidence does not alter v1.0.0. |
...
| ✅ | Fabric 26.2 main menu → fresh world → authenticated MCP | 100 asserted records; Java 25/Loom 1.17.1 exact client, typed discovery, UI selectors, key/mouse cleanup, explicit world creation, and expected unsupported states |
| ✅ | Fabric 26.2 real world + container control | 25/25 asserted records; reversible gold-block mutation/readback, client-context player look readback/restore, screenshot, revision/46-slot container read, guarded empty-slot click/readback/close, and explicit heightmap/light/move/slot/chat-read/furniture unsupported states |
