...
| Fabric adapter | Minecraft Java 1.20.1 | Fabric Loader 0.15.11, Fabric API 0.92.2+1.20.1, Fabric Loom 1.10.5, Gradle 8.14 | integration-tested (packaged matrix); manually verified client-menu slice (post-v1 source) | `verification/evidence/compatibility-live-2026-07-12.md` and `verification/evidence/fabric-1.20.1-client-menu-live-2026-07-14.md` | Bounded overworld writes and loaded-entity queries are live-tested. Authenticated client UI state and guarded menu click reached a fresh world with omitted-button defaulting verified. A committed world-open timeout correctly quarantined later mutations; connected-player mutation, containers/NBT, and broader mod interoperability remain open. This does not change immutable v1.0.0 bytes. |
