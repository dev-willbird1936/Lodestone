...
| Fabric adapter | Minecraft Java 1.21.1 | Fabric Loader 0.16.10, Fabric API 0.116.9+1.21.1, Fabric Loom 1.10.5, Gradle 8.14 | integration-tested (packaged matrix); manually verified client slice | `verification/evidence/compatibility-live-2026-07-12.md` plus `verification/evidence/fabric-1.21.1-client-live.md` | Connected player/input/UI slice is verified; open-container slots/revision, container click bounds, entity interaction, and text insertion are compiled and permission-gated; broader mutation/event coverage remains open |
