...
| Fabric adapter | Minecraft Java 1.20.1 | Fabric Loader 0.15.11, Fabric API 0.92.2+1.20.1, Fabric Loom 1.10.5, Gradle 8.14 | integration-tested (packaged matrix) | `verification/evidence/compatibility-live-2026-07-12.md` plus live evidence | Bounded overworld writes and loaded-entity queries are live-tested; client input/UI/container snapshot/click, entity interaction, and text insertion compile/package; manual client acceptance, NBT, and broader mod interoperability remain open |
