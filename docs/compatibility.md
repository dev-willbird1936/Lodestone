...
| Fabric adapter | Minecraft Java 26.2 | Fabric Loader 0.19.3, Fabric API 0.154.2+26.2, Fabric Loom 1.17.1, Gradle 9.6.1, Java 25 | integration-tested (packaged matrix); ordered fresh-client flow verified post-v1 source | `verification/evidence/fabric-26.2-flow-main-menu-20260715T073956Z.json`, `verification/evidence/fabric-26.2-flow-world-20260715T074031Z.json`, and `verification/evidence/fabric-26.2-flow-shutdown-20260715T074050Z.json` | Exact final artifact SHA-256 `ec6761e07ef9ad564044d32c5cfdb421f4314cebd301242184d5ce40b869e972`; client flow passes typed MCP/UI/input, fresh-world mutation/readback, bundled `simple_chair` stateful furniture placement/readback/restoration, client-context look mutation/readback/restore, container/menu control, screenshot, and clean shutdown. Heightmap/light/move/slot/chat-read remain honest unsupported states; Vulkan is not tested |
...
| Forge host + adapter | Minecraft Java 1.20.1 | Forge 47.4.10, ForgeGradle 6.0.25, Gradle 8.14, Java 21 | integration-tested (packaged matrix); ordered fresh-client flow verified post-v1 source | `verification/evidence/compatibility-live-2026-07-12.md`, `verification/evidence/forge-1.20.1-flow-main-menu-20260714T215732Z.json`, `verification/evidence/forge-1.20.1-flow-world-20260714T215815Z.json`, and `verification/evidence/forge-1.20.1-flow-shutdown-20260714T215827Z.json` | Exact artifact SHA-256 `1b6aaa36a40841c0cb92fe7213e3b25b89f728cf9efed8288a3971fda8757096`; fresh flow passed 100/100 main-menu, 15/15 minimal-world mutation/readback, and 6/6 clean-shutdown assertions. The adapter reports unsupported text/legacy input states honestly. |
