...
| --- | --- | --- | --- | --- | --- |
| NeoForge host + adapter | Minecraft Java 1.21.1 | NeoForge 21.1.211, NeoGradle 7.1.38, Gradle 8.14 | integration-tested (packaged matrix); manually verified client slice | `verification/evidence/compatibility-live-2026-07-12.md` plus `verification/evidence/neoforge-1.21.1-client-live.md` | Connected player/input/UI slice is verified; open-container read now exposes stable slots/revision; container click remains explicitly unavailable; broader mutation/event coverage remains open |
